...
open class Config {
  ...
  private static let font = UIFont.init(name: "SFProDisplay-Regular", size: UIFont.labelFontSize)
  ...
  public static func retrieveConfigurationWizardCustomization() ->
      FaceTecCustomization {
          ...
          defaultCustomization.guidanceCustomization.buttonFont = font ?? defaultCustomization.guidanceCustomization.buttonFont
